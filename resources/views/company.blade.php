...
<h1 class="title-heder-line title-colored-black" data-ix="title">Живи, Готуй, Кохай.</h1>
</div>
</div>
...
<div class="col1-r w-col w-col-7">
    <p> Готувати з любов'ю означає покращувати якість життя: важливий принцип, якого ILVE завжди дотримується. Наші колекції вирішують потреби людей чітко, послідовно та елегантно. </p>
    <p> Від привабливості класичних стилів до нових тенденцій дизайну ILVE розробляє прилади, які прикрашають, приділяючи максимум уваги технології та деталям. </p>
</div>
</div>
...
<img src="https://www.ilve.it/wp-content/uploads/2020/03/ILVE_Azienda_Live_CCSTAR_PP_SS_Gen_Front.jpg" alt="">
</div>
...
<p> Більше 50 років ILVE є справжнім фахівцем з кулінарних систем. 
    ...
    які підвищили рівень продуктивності, безпеки та задоволеності на кухні: адже добре готувати - означає любити себе. </p>
    ...
    <p> Заснована і розширена в Камподарсего в районі Падуї в 1969 році, на працьовитому Північному Сході Італії, 
        ...
        дослідженнями в галузі процесів і технологій. Успіх ILVE пояснюється надзвичайною гнучкістю в дизайні та виробництві,
         для задоволення будь-яких потреб на кухні. Колекції ILVE ефективні, універсальні та надійні: 
         розроблені для того, щоб радувати вас день у день. </p></div>
</div>
<div id="imagetextandlink-block_5e749e19b0184" class="block-2 w-row imagetextandlink-block invert">
<div class="col-2-image w-col w-col-6">
<img src="https://www.ilve.it/wp-content/uploads/2020/03/ILVE_Azienda_Cook_P128WE3_SS_DET_03.jpg" alt="">
</div>
<div class="col2-txt w-col w-col-6">
<h2>Готування,</h2>
...
<div class="col-2-image w-col w-col-6">
<img src="https://www.ilve.it/wp-content/uploads/2020/03/ILVE_Azienda_Love_M127DNE3_WHB_AM120_AMB_DET_01.jpg" alt="">
</div>
<div class="col2-txt w-col w-col-6">
<h2>Любов</h2>
     ...
     досконалим та унікальним інструментам, покликаним доставляти радість
      та задоволення тим, хто по-справжньому любить готувати. Якості, які
       ...
       існує лише одна пристрасть до приготування їжі, смаки особистого декору
        ...
        Ось чому колекції ILVE мають різні стилі, але всі поділяють одну мету: запропонувати новітні рішення, зробити приготування їжі щоденним задоволенням. </p>
    </div>
</div>
<div id="twocolsgrey-block_5e749facb0186" class="block-3 w-row twocolsgrey-block invert">
<div class="col-3-img w-col w-col-6">
<img src="https://www.ilve.it/wp-content/uploads/2020/03/ILVE_Azienda_Cert_MPD10SNE3_MGP_ANB100_DET_02.jpg" alt="" class="image-11">
</div>
...
<p> Надійність продуктів і послуг ILVE визнана на ринку вже понад 50 років. Кожна 
    ...
    Це гарантує ідеальну роботу протягом десятиліть, про що свідчить задоволення великої кількості
     клієнтів, які готують за допомогою надзвичайних машин з точки зору функціональності, безпеки та довговічності. </p>
</div>
</div>
@endsection